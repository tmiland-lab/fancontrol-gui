                ...
                Rectangle {
                    ...
                    Canvas {
                        ...
                        onPaint: {
                            ...
                            // Theme-aware cool-to-warm gradient
                        ...
                        Connections {
                            ...
                            function onMinPwmChanged() { curveCanvas.markDirty(Qt.rect(0, 0, stopPoint.x, stopPoint.y)) }
                        }
                    }
                    Canvas {
                        id: meshCanvas
                    ...
                    PwmPoint {
                        ...
                        color: !!fan ? fan.hasTemp ? root.coolColor : Qt.tint(Kirigami.Theme.disabledTextColor, Qt.rgba(0, 0, 1, 0.5)) : "transparent"
                        size: graph.fontSize
                    ...
                    PwmPoint {
                        ...
                        color: !!fan ? fan.hasTemp ? root.warmColor : Qt.tint(Kirigami.Theme.disabledTextColor, Qt.rgba(1, 0, 0, 0.5)) : "transparent"
                        size: graph.fontSize
                        visible: !!fan ? fan.hasTemp : false
                        draggable: root.editable
